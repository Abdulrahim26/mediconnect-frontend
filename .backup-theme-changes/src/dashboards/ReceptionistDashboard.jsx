...
function ReceptionistDashboard() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-full items-center justify-center bg-mc-50 p-6">
        <div className="rounded-2xl bg-white px-8 py-6 text-center shadow-sm">
          <div className="mx-auto h-8 w-8 animate-spin rounded-full border-4 border-mc-100 border-t-mc-600" />

...
function DoctorDashboard() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-full items-center justify-center p-6 bg-mc-50">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Link
            ...
            className="rounded-2xl border border-mc-100 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-mc-200 hover:shadow-md"
          >

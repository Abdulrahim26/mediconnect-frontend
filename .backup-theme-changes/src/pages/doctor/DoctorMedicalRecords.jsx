...
function DoctorMedicalRecords() {
  ...
  if (loading) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-mc-50">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <Link
            ...
            className="rounded-lg bg-mc-600 px-5 py-3 text-center font-semibold text-white hover:bg-mc-700"
          >
            + Create Record
          </Link>
        </div>

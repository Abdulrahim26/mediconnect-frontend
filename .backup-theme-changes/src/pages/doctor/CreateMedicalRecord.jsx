      ...
      <div className="mx-auto max-w-4xl">
        ...
        <header className="mb-8">
          <Link
            ...
            className="text-sm font-semibold text-mc-600 hover:text-mc-700"
          >
        ...
        <section className="rounded-2xl bg-white p-6 shadow-sm md:p-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              {loadingAppointments ? (
                <div className="rounded-lg border border-mc-100 bg-mc-50 px-4 py-3 text-slate-600">
                ...
                <>
                  <select
                    ...
                    required
                    className="w-full rounded-lg border border-mc-100 bg-white px-4 py-3 text-slate-900 outline-none focus:border-mc-600 focus:ring-2 focus:ring-mc-100"
                  >
                    <option value="">

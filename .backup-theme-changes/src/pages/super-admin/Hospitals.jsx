...
function Hospitals() {
  ...
  return (
    <main className="min-h-full bg-mc-50 p-4 sm:p-6 md:p-8">
      <div className="mx-auto max-w-7xl">
        ...
        <header className="mb-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
              <p className="text-sm font-semibold text-mc-600">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-lg bg-mc-600 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-mc-700"
            >
              + Add Hospital
            </Link>
        ...
        {!loading && (
          <section className="mb-6">
            <div className="rounded-2xl border border-mc-100 bg-white p-5 shadow-sm">

              <div className="flex items-center gap-4">

                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-mc-100 text-2xl">
                  🏥
                </div>

                <div>
                  <p className="text-sm font-medium text-mc-700">
        ...
        <section className="overflow-hidden rounded-2xl border border-mc-100 bg-white shadow-sm">
          ...
          <div className="border-b border-mc-100 p-5 sm:p-6">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              {!loading && (
                  <span className="text-sm font-medium text-mc-700">
                    {hospitals.length}{' '}
                    {hospitals.length === 1
                      ? 'hospital'
                      : 'hospitals'}
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center p-12">
              ...
              <div className="mb-4 h-10 w-10 animate-spin rounded-full border-4 border-mc-100 border-t-mc-600" />
          ...
          {!loading && hospitals.length === 0 && (
            <div className="p-10 text-center">
              ...
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-mc-50 text-2xl">
                🏥
              </div>
              ...
              <p className="mx-auto mt-2 max-w-md text-sm text-mc-700">
              ...
              <Link
                to="/super-admin/hospitals/create"
                className="mt-5 inline-flex rounded-lg bg-mc-600 px-5 py-3 text-sm font-semibold text-white hover:bg-mc-700"
              >
                Add First Hospital
              </Link>
              ...
              <table className="min-w-full">
                ...
                <tbody className="divide-y divide-mc-100">
                  ...
                  {hospitals.map((hospital) => (
                    <tr
                      key={hospital.id}
                      className="transition hover:bg-mc-50"
                    >
                      ...
                      <td className="px-6 py-5">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-mc-100 text-lg">
                            🏥
                          </div>
                      ...
                      <td className="px-6 py-5">
                        ...
                        <div className="flex justify-end gap-2">
                          ...
                          <Link
                            ...
                            className="rounded-lg border border-mc-100 px-3 py-2 text-sm font-semibold text-mc-700 transition hover:border-mc-200 hover:bg-mc-50 hover:text-mc-700"
                          >
                            Edit
                          </Link>

          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  disabled={loading}
                  className="w-full rounded-lg border border-slate-200 px-4 py-3 outline-none transition focus:border-blue-600 focus:ring-2 focus:ring-slate-100 disabled:bg-slate-50"
                />
              </div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <button
                ...
                disabled={loading}
                onClick={handleClear}
                className="rounded-lg border border-slate-200 bg-white px-6 py-3 font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
              >
                Clear
              </button>
              ...
              {departments.map((department) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <span className="w-fit rounded-lg bg-slate-100 px-3 py-2 text-xs font-semibold text-blue-700">
                      Department
                    </span>

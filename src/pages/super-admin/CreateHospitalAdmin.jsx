          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                disabled={submitting}
                className="w-full rounded-lg border border-blue-200 bg-white px-4 py-3 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:bg-blue-50"
              />
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-blue-200 bg-white px-4 py-3 text-sm text-slate-800 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:bg-blue-50"
              >
                <option value="">
                  {loadingHospitals
                    ? 'Loading hospitals...'
            ...
            <div className="flex flex-col-reverse gap-3 border-t border-blue-100 pt-6 sm:flex-row sm:justify-end">
              ...
              <Link
                to="/super-admin/hospital-admins"
                className="inline-flex items-center justify-center rounded-lg border border-blue-200 px-5 py-3 text-sm font-medium text-slate-700 transition hover:bg-blue-50"
              >
                Cancel
              </Link>

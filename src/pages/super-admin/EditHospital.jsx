          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-blue-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:bg-blue-50"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full resize-none rounded-lg border border-blue-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:bg-blue-50"
              />
            </div>
            ...
            <div className="flex flex-col-reverse gap-3 border-t border-blue-100 pt-6 sm:flex-row sm:justify-end">
              ...
              <Link
                to="/super-admin/hospitals"
                className="rounded-lg border border-blue-200 px-5 py-3 text-center text-sm font-medium text-slate-700 transition hover:bg-blue-50"
              >
                Cancel
              </Link>

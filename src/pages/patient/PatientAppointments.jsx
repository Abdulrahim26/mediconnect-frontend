      ...
      <div className="mx-auto max-w-7xl">
        ...
        {reschedulingId && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
            ...
            <section className="w-full max-w-lg rounded-2xl border border-blue-100 bg-white p-6 shadow-xl">
              ...
              <form onSubmit={handleReschedule}>
                ...
                <div className="mt-6 flex justify-end gap-3">
                  ...
                  <button
                    ...
                    className="rounded-lg bg-blue-50 px-5 py-3 font-semibold text-blue-700 hover:bg-blue-100 disabled:opacity-50"
                  >
                    Cancel
                  </button>

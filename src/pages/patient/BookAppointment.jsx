  ...
  if (!doctor) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-blue-50 p-6">
        <section className="rounded-2xl border border-blue-100 bg-white p-8 text-center shadow-lg">
    ...
    <div className="p-6 md:p-8">
      <div className="mx-auto max-w-3xl">
        ...
        <button
          ...
          className="mb-6 rounded-lg border border-blue-100 bg-white px-4 py-2 font-medium text-slate-700 shadow-sm hover:bg-blue-50"
        >
          ← Back to Doctor
        </button>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full rounded-lg border border-blue-200 bg-white px-4 py-3 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                />
              </div>

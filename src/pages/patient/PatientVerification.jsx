...
function getStatusClasses(status) {
  switch (status) {
    ...
    case 'NOT_VERIFIED':
    default:
      return 'bg-blue-50 text-slate-600 border-blue-100'
  }
}
...
function PatientVerification() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-full items-center justify-center bg-blue-50 p-6">
          ...
          >
            ...
            <div className="mt-2 flex flex-col gap-3 sm:flex-row">
              <input
                ...
                autoComplete="off"
                className="w-full rounded-xl border border-blue-200 bg-white px-4 py-3 text-sm font-medium uppercase text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:bg-blue-50 sm:max-w-md"
              />
          ...
          >
            ...
            <div className="mt-2 flex flex-col gap-3 sm:flex-row">
              ...
              <input
                ...
                autoComplete="off"
                className="w-full rounded-xl border border-blue-200 bg-white px-4 py-3 text-sm font-medium tracking-wider text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:bg-blue-50 sm:max-w-md"
              />

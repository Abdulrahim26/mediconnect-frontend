      ...
      <div className="mx-auto max-w-7xl">
        ...
        <header className="mb-8">
          ...
          <p className="mt-2 text-slate-600">
            Search for doctors by name, specialty, department, hospital, or location.
          </p>
        </header>
          ...
          <form onSubmit={handleSearch}>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-6">
              ...
              <input
                ...
                className="rounded-lg border border-blue-200 bg-white px-4 py-3 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
              />
